...
```{r cache.path = paste("cache/",config_hash)}
...
#| label: anno-cols
#| eval: false
# TODO: ^ fix this hardcoding and rm the eval: false
    # In summary, only add anno_cols to the META "ancestry" sumstats file.
...
## fgwas
```{r cache.path=paste("config/",config_hash)}
#| label: fgwas
#| cache: true
