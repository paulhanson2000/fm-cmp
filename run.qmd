...
# TODO: Actually probably not necessary, will get removed later by fgwas etc. anyway right?
...
mapply(sumstats, names(sumstats), SIMPLIFY=F, FUN=function(s,s_nm) { # TODO: embarassingly parallel mapply
  ...
  best_annos <-fgwasGetBestXValidatedAnnos(input_filename, l$best_penalty, annos, l$best_xv_llk)
