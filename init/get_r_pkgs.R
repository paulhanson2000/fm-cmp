install.packages(c("BiocManager", "remotes", "quarto", "kableExtra", "yaml", "jsonlite", "R.utils", "data.table", "Ckmeans.1d.dp"), repos="https://cloud.r-project.org") # TODO: is Ckmeans.1d.dp (recommended but optional by PolyFun) actually needed?
