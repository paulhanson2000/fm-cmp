...
sumstats <- mapply(sumstats, names(sumstats), data_config$ancestry, SIMPLIFY=F, FUN = function(s, s_nm, anc) {
  ...
  unshared <- s$rs_id %ni% seqGetData(ref, "annotation/id") # Done *before* filtering by mac/maf/miss, or else n_unshared would unfairly count variants dropped for other reasons. I.e. dropping due to bad mac/maf/miss is acceptable, but dropping lots of variants because unshared is more suspicious.
