...
lapply(1:nrow(loci_configs), function(r) {
  system(paste("../third_party/SuSiEx/bin/SuSiEx",
               ...
               "--ld_file",  paste(collapse=',', paste0("in/ld/",loci_configs[r,locus],"-",unique(data_configs$ancestry),"-susiex")), # TODO: BEFORE RUNNING ALL LOCI, figure out elegant way to put in project folder. Symbolic link didn't work last I checked :(
               ...
               "--maf 0.05", # Default. TODO:
               "--mult-step True",
               "--keep-ambig True",
               "--threads", 6L # TODO: more general
               # defaults: --max_iter=100, --pval_thresh=1e-5, --tol=1e-4, --n_sig=5, --min_purity=0.5
  ))
})
```
