...
```{r}
#| cache: true
eas <- fread("../data/DIAMANTE2022/sumstat/DIAMANTE-EAS.sumstat.txt", header=T, select=c("rsID", "chromosome(b37)", "position(b37)", "effect_allele_frequency"))
eur <- fread("../data/DIAMANTE2022/sumstat/DIAMANTE-EUR.sumstat.txt", header=T, select=c("rsID", "chromosome(b37)", "position(b37)", "effect_allele_frequency"))
sas <- fread("../data/DIAMANTE2022/sumstat/DIAMANTE-SAS.sumstat.txt", header=T, select=c("rsID", "chromosome(b37)", "position(b37)", "effect_allele_frequency"))
```
